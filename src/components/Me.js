function Me() {
    return (
        <section id="me" class="h-screen bg-gray-800 text-white text-center grid place-items-center">
                <div>
                    <p class="text-lg font-bold italic uppercase tracking-wider">My name is</p>
